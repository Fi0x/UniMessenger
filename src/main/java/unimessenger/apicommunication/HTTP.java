...
public class HTTP
{
    ...
    public static HttpResponse<String> sendRequest(String url, Variables.REQUESTTYPE type, String body, String... headers)//TODO: Make not static because multiple threads use it
    {
