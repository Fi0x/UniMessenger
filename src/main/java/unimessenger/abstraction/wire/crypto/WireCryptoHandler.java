...
public class WireCryptoHandler
{
    ...
    public static Prekey[] generatePreKeys(int start, int count)
    {
        ...
        {
            Out.create("Crypto Exception while generating PreKeys", "WireCryptoHandler").debug().ERROR().print();
            cleanUp();
        }
        return Keys;
    }
    ...
    public static Prekey generateLastPrekey()
    {
        ...
        {
            Out.create("Exception while generating LastKey", "WireCryptoHandler").debug().ERROR().print();
        }
        return null;
    }
    ...
    public static String encrypt(String userID, String clientID, Prekey pk, byte[] content)
    {
        ...
        {
            Out.create("Encrypting message failed", "WireCryptoHandler").debug().ERROR().print();
        }
    ...
    public static byte[] decrypt(UUID from, String sender, String text)
    {
        ...
        {
            Out.create("Decrypt CryptoException", "WireCryptoHandler").always().ERROR();
            dec = new byte[1];
        }
